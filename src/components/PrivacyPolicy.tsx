...
export default function PrivacyPolicy() {
  return (
    <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-slate-800">
      <h1 className="text-3xl font-display font-bold mb-8 text-slate-900 border-b pb-4">Chính sách bảo mật</h1>
      <div className="space-y-6 text-[15px] leading-relaxed">
        ...
        <h2 className="text-xl font-bold mt-8 mb-4">1. Thu thập thông tin</h2>
        ...
        <h2 className="text-xl font-bold mt-8 mb-4">2. Sử dụng thông tin</h2>
        ...
        <h2 className="text-xl font-bold mt-8 mb-4">3. Bảo mật dữ liệu</h2>
        ...
        <h2 className="text-xl font-bold mt-8 mb-4">4. Chia sẻ thông tin</h2>
        ...
        <h2 className="text-xl font-bold mt-8 mb-4">5. Thông tin liên hệ</h2>

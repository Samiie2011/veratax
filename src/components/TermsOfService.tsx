...
export default function TermsOfService() {
  return (
    <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-slate-800">
      <h1 className="text-3xl font-display font-bold mb-8 text-slate-900 border-b pb-4">Điều khoản dịch vụ</h1>
      <div className="space-y-6 text-[15px] leading-relaxed">
        ...
        <h2 className="text-xl font-bold mt-8 mb-4">1. Phạm vi dịch vụ</h2>
        ...
        <h2 className="text-xl font-bold mt-8 mb-4">2. Trách nhiệm của Veratax</h2>
        ...
        <h2 className="text-xl font-bold mt-8 mb-4">3. Trách nhiệm của khách hàng</h2>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <h2 className="text-xl font-bold mt-8 mb-4">4. Hiệu lực và Chấm dứt</h2>
